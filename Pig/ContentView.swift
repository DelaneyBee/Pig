...
//  Pig Take 2
//
//  Created by Delaney Blaszinski on 11/6/24.
//
                ...
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text("If the player rolls any other number, it is added to their turn total, and the player's turn continues.")
                            .padding()
                        Text("If the player chooses to \"hold\", their turn is added to the game score, and it becomes the next players turn.")
                            .padding()
                        Text("A player wins the game when the score reaches 100 or more on their turn")
                            .padding()
                    }
                    Spacer()
                }
